...
The theory of backpropagation, as discussed in [Backpropagation basics](/posts/backpropagation-basics/), is rather simple: compute the forward pass, calculate the loss, and apply the sum rule and the chain rule for each parameter.
